...
const Collections = () => {
  ...
  const toggleCategory = (e) => {
    const { value } = e.target; // Extract value for readability
    setCategory((prev) =>
      prev.includes(value)
  ...
  return <div className="flex flex-col sm:flex-row gap-1 sm:gap-10  pt-10 border-t">
    {/* Filter Options */}
    <div className="min-w-60">
      ...
      <div className={`border  border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'}`}>
        ...
        <div className="flex flex-col text-gray-700 text-sm gap-2 font-light">
    ...
    <div className="flex-1">
      <div className="flex justify-between text-base sm:text-2xl mb-4">
        ...
        {/* Products Sort */}
        <select className="border border-gray-300 sm:text-sm px-2" onChange={(e) => setSortType(e.target.value)}>
