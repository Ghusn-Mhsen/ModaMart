...
const About = () => {
  return <div className="text-2xl  text-center  pt-8 border-t">
    ...
    <div className="text-4xl py-4">
      ...
      <div className="flex flex-col md:flex-row text-sm  mb-20 mt-10">
        ...
        <div className="border  px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Convenience:</b>
          <p className="text-gray-600">WWith our user-friendly interface and hassle-free ordering process, shopping has never been easier.</p>
        </div>
        <div className="border  px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
